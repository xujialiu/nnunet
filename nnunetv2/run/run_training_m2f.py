"""Training module for nnUNet with Mask2Former decoder."""
...
def get_trainer_from_args(
    ...
    configuration: str,
    fold: int,
    trainer_name: str = "nnUNetTrainer_m2f",
    plans_identifier: str = "nnUNetPlans",
    device: torch.device = torch.device("cuda"),
    m2f_config_path: Optional[str] = None,
):
    """Get trainer instance from arguments.
    ...
    # Create trainer with M2F-specific config path
    nnunet_trainer = nnunet_trainer(
        ...
        device=device,
        m2f_config_path=m2f_config_path,
    )
    return nnunet_trainer


def maybe_load_checkpoint(
    nnunet_trainer: nnUNetTrainer_m2f,
...
def run_ddp(
    ...
    nnunet_trainer = get_trainer_from_args(
        dataset_name_or_id, configuration, fold, tr, p, m2f_config_path=m2f_config_path
    )
...
def run_training(
    ...
    configuration: str,
    fold: Union[int, str],
    trainer_class_name: str = "nnUNetTrainer_m2f",
    plans_identifier: str = "nnUNetPlans",
...
def run_training_entry():
    ...
    parser = argparse.ArgumentParser(
        description="Train nnUNet with Mask2Former decoder"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default="nnUNetTrainer_m2f",
        help="[OPTIONAL] Use this flag to specify a custom trainer. Default: nnUNetTrainer_m2f",
    )
    parser.add_argument(
        "-p",
        type=str,
    ...
    parser.add_argument(
        ...
        required=False,
        default=None,
        help="[OPTIONAL] Path to M2F YAML config file. If not specified, uses default config.",
    )
    parser.add_argument(
        "--npz",
        action="store_true",
